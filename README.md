...
The smoke test uses headless Microsoft Edge to verify preparation, all required Foundations, the meditation completion gate, seven sequential practice days, weekly repeat behavior, preserved entries, and the Settings progression override.
